...
public class EnemyRoaming : BaseState
{
    ...
    public override void UpdateLogic()
    {
        ...
        //_sm.CheckPlayerInRange(30); //провер€ем дистанцию до игрока (метод в стейтмашине)
    ...
    {
        base.UpdatePhysics();
        if (timerEnded == false && _sm.aIPath.reachedEndOfPath == true) //если таймер не закончен » пришли к цели
        {
        ...
        if (timerEnded == true && _sm.aIPath.reachedEndOfPath == true) //если таймер закончен » пришли к цели
        {
