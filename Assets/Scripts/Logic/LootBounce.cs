...
public class LootBounce : MonoBehaviour
{
	...
	void CreateBody()
	{
		...
		sprRndBody.color = sprRndCaster.color; // Установка цвета равного цвету родительского объекта
		sprRndBody.transform.localScale = Vector3.one;  // Установка масштаба равного масштабу родительского объекта
	}
	...
	void CreateShadow()
	{
		...
		sprRndShadow.transform.localScale = Vector3.one; // Установка масштаба равного масштабу родительского объекта
	}
